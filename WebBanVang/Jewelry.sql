...
INSERT INTO products VALUES
    ( 1, 1, 'Gold Ring', 'A beautiful 24K gold ring', 'ring.jpg', 1000, 1.0, 200000,1.3, 6000000, 'S', 6,'active'),
    ( 2, 2, 'Gold Necklace', 'Elegant 18K gold necklace', 'necklace.jpg', 500, 1.3, 300000,1.4, 7000000, 'M', 4,'active'),
	( 2, 2, 'Gold Necklace 1', 'Elegant 18K gold necklace', 'necklace.jpg', 500, 1.3, 300000,1.5, 7000000, 'M',3, 'active');
INSERT INTO stones VALUES
    ( 1, 'Diamond', 'Gemstone', 1500000,'active','true', 'White'),
    (2, 'Ruby', 'Gemstone', 1000000,'active' ,'true','Red'),
	 (3, 'Ruby', 'Gemstone', 1200000,'active' ,'true','blue')
